...
export const metadata: Metadata = {
  ...
  description:
    "Every surgical and non-surgical treatment at Perfect Eyes Clinic, from blepharoplasty and ptosis surgery to tear trough fillers, polynucleotides and laser.",
