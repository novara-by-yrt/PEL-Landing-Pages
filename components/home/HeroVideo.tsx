 ...
 *    The hero's LCP element is the headline, and a decorative video has no
 *    business competing with it for bandwidth — the swatch frame covers the
 *    gap, so nothing renders empty in the meantime.
 *
