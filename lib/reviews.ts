 ...
 * no platform or procedure against these quotes.
 */
export const PATIENT_STORIES: PatientStory[] = [
  ...
  /* Supplied by the clinic and reproduced word for word — no trimming or
     tidying, so nothing here is a materially altered testimonial. */
  {
    quote:
